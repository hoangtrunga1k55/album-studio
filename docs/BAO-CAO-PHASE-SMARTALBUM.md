...
**Ngày:** 08/07/2026 · **Bản build:** v0.2.0 · **Người thực hiện:** Trung (+ AI pair-programming)
...
| **§9** Typography | Điểm yếu của SmartAlbum | ✅ **vượt** | Đây là lợi thế của ta: **kho 5168 font Việt** (index + nạp theo nhu cầu, khớp tên PostScript), chữ template sửa trực tiếp (đúng font gốc, cỡ chuẩn từ PSD), typo pack chèn/resize/đổi màu, thêm chữ mới, snippet câu Việt — SmartAlbum không làm được mảng này |
...
| **§14** Shortcuts | Phím tắt | ✅ 100% | ⌘N/⌘O/⌘S/⌘D/⌘⇧D/⌘E/⌘B/⌘R/⌘+/⌘−/⌘0/Space/PgUp-PgDn/←→/1–5/6–9/0/X/Enter/Esc — đủ bảng §14.1 |
...
6. Click chữ trên layout Tizino → sửa nội dung/đổi font từ kho → kéo/resize.
